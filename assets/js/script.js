...
(function($) {
    ...
    if ($('.ef-site-header .navigation').length) {
        cloneNavForSticyMenu($('.ef-site-header .navigation'), "sticky-header");
    }
    ...
    function stickyMenu($targetMenu, $toggleClass, $topOffset) {
        ...
        var mainMenuTop = $('.ef-site-header .navigation');
...
/*------------------------------------------
    ...
    /*------------------------------------------
        = ef-project-single-main-img
    -------------------------------------------*/
    if($(".ef-project-single-main-img".length)) {
        $(".ef-project-single-main-img").owlCarousel({
            mouseDrag: false,
            smartSpeed: 500,
            margin: 30,
            loop:true,
    ...
    $(window).on("scroll", function() {
		...
		if ($(".ef-site-header").length) {
           stickyMenu( $('.ef-site-header .navigation'), "sticky-on" );
        }
